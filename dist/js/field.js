...
var render = function() {
  ...
  return _vm.field.visible
    ? _c("span", { staticClass: "block text-center" }, [
        _c(
          "a",
          _vm._b(
            { class: _vm.field.classes, attrs: { href: _vm.field.url } },
            "a",
            _vm.field.attributes,
            false
          ),
          [_vm._v("\n    " + _vm._s(_vm.field.linkText) + "\n  ")]
        )
      ])
    : _vm._e()
}
